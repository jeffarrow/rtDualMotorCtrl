 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateFaultFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Fault function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateInitFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Init function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateStopFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Stop function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateRunFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Run function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateFaultSlow(sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateInitSlow(sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateStopSlow(sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void SM_StateRunSlow(sm_app_ctrl_t *psAppCtrl)
{
