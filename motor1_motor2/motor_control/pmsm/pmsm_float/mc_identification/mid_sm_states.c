...
mid_sm_app_state_fcn_t msSTATE = {
 ...
 */
mid_sm_app_trans_fcn_t msTRANS = {
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateStart(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StatePwrStgCharact(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateRs(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateLd(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateLq(void)
{
    /* Type the code to do when in the LS state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StatePp(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateKe(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateMech(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateHall(void)
{
    /* Type the code to do when in the MECH state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_StateStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransStart2PwrStgCharact(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransStart2Rs(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransStart2Pp(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransStart2Mech(void)
{
    /* Type the code to do when going from the LS to the STOP state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransStart2Hall(void)
{
    /* Type the code to do when going from the LS to the STOP state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransPwrStgCharact2Stop(void)
{
    /* Type the code to do when going from the PWR_STG_CHARACT to the RS state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransRs2Ld(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransLd2Lq(void)
{
    /* Type the code to do when going from the RS to the LS state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransLq2Ke(void)
{
    /* Type the code to do when going from the LS to the STOP state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransKe2Stop(void)
{
    /* Type the code to do when going from the LS to the STOP state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransPp2Stop(void)
{
    /* Type the code to do when going from the LS to the STOP state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransMech2Stop(void)
{
    /* Type the code to do when going from the LS to the STOP state */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_TransAll2Stop(void)
{
