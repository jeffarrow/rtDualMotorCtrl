...
sm_app_state_fcn_t s_M2_STATE_FAST = {M2_StateFaultFast, M2_StateInitFast, M2_StateStopFast, M2_StateRunFast};

/*! @brief Application state machine table - slow */
sm_app_state_fcn_t s_M2_STATE_SLOW = {M2_StateFaultSlow, M2_StateInitSlow, M2_StateStopSlow, M2_StateRunSlow};

/*! @brief Application sub-state function field - fast */
pfcn_void_void s_M2_STATE_RUN_TABLE_FAST[7] = {
    M2_StateRunCalibFast, M2_StateRunReadyFast,     M2_StateRunAlignFast,  M2_StateRunStartupFast,
    M2_StateRunSpinFast,  M2_StateRunFreewheelFast, M2_StateRunMeasureFast};

/*! @brief Application sub-state function field - slow */
pfcn_void_void s_M2_STATE_RUN_TABLE_SLOW[7] = {
    M2_StateRunCalibSlow, M2_StateRunReadySlow,     M2_StateRunAlignSlow,  M2_StateRunStartupSlow,
    M2_StateRunSpinSlow,  M2_StateRunFreewheelSlow, M2_StateRunMeasureSlow};
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateFaultFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateInitFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateStopFast(void)
{
    /* read ADC results (ADC triggered by HW trigger from PDB) */
    /* get all adc samples - DC-bus voltage, current, bemf and aux sample */
    M2_MCDRV_ADC_GET(&g_sM2AdcSensor);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunFast(void)
{
    /* get all adc samples - DC-bus voltage, current, bemf and aux sample */
    M2_MCDRV_ADC_GET(&g_sM2AdcSensor);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateFaultSlow(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateInitSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateStopSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunSlow(void)
{
    /* Run sub-state function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransFaultStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransInitFault(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransInitStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransStopFault(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransStopRun(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunFault(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunCalibFast(void)
{
...
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunMeasureFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunReadyFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunAlignFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunStartupFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunSpinFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunFreewheelFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunCalibSlow(void)
{
    if (--g_sM2Drive.ui16CounterState == 0U)
    {
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunMeasureSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunReadySlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunAlignSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunStartupSlow(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunSpinSlow(void)
{
    if (g_sM2Drive.eControl == kControlMode_SpeedFOC)
    {
        /* Actual speed filter */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_StateRunFreewheelSlow(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunCalibReady(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunCalibMeasure(void)
{
    ...
    g_sM2Drive.sFocPMSM.f16PosElExt = FRAC16(0.0);
...
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunMeasureReady(void)
{
    /* Type the code to do when going from the RUN CALIB to the RUN READY sub-state */
    /* Set off measurement */
    g_sMID.bEnableMeasurement = FALSE;
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunReadyAlign(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunAlignStartup(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunAlignSpin(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunAlignReady(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunStartupSpin(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunStartupFreewheel(void)
{
    M2_MCDRV_PWM3PH_DIS(&g_sM2Pwm3ph);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunSpinFreewheel(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_TransRunFreewheelReady(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_ClearFOCVariables(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M2_FaultDetection(void)
{
...
//        }
        ...
        g_sM2Drive.fltBemfUqAvg =
            GDFLIB_FilterMA_FLT(g_sM2Drive.sFocPMSM.sBemfObsrv.sEObsrv.fltQ, &g_sM2Drive.msM2BlockedRotorUqFilt);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void M2_SetAppSwitch(bool_t bValue)
{
