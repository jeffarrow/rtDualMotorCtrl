...
#define M2_ALIGN_VOLTAGE                   (1.5F)
#define M2_ALIGN_DURATION                  (5000)
//Application counters                  
#define M2_CALIB_DURATION                  (200)
#define M2_FAULT_DURATION                  (3000)
#define M2_FREEWHEEL_DURATION              (1000)
//Miscellaneous                         
#define M2_E_BLOCK_TRH                     (0.8F)
...
#define M2_D_KP_GAIN                       (2.153274122872F)
#define M2_D_KI_GAIN                       (0.789568352087F)
//Q-axis Controller - Parallel type     
#define M2_Q_KP_GAIN                       (2.153274122872F)
#define M2_Q_KI_GAIN                       (0.789568352087F)
...
#define M2_SPEED_PI_PROP_GAIN              (0.00974F)
#define M2_SPEED_PI_INTEG_GAIN             (0.0000857F)
...
//----------------------------------------------------------------------
//Bemf DQ Observer                      
#define M2_I_SCALE                         (0.847457627119F)
#define M2_U_SCALE                         (0.42372881356F)
#define M2_E_SCALE                         (0.42372881356F)
#define M2_WI_SCALE                        (0.000084745763F)
#define M2_BEMF_DQ_KP_GAIN                 (0.393982236862F)
#define M2_BEMF_DQ_KI_GAIN                 (0.071061151688F)
...
//----------------------------------------------------------------------
#define M2_SCALAR_VHZ_FACTOR_GAIN          (0.058499999999999996F)
#define M2_SCALAR_INTEG_GAIN               ACC32(0.058666666667)
#define M2_SCALAR_RAMP_UP                  (0.066666666667F)
#define M2_SCALAR_RAMP_DOWN                (0.066666666667F)
