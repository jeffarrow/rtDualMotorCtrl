 ...
 * @return none
 */
__RAMFUNC(SRAM_ITC_cm7) void MCDRV_QdEncGet(mcdrv_qd_enc_t *this)
{
 ...
 * @return none
 */
__RAMFUNC(SRAM_ITC_cm7) void MCDRV_QdEncClear(mcdrv_qd_enc_t *this)
{
 ...
 * @return none
 */
__RAMFUNC(SRAM_ITC_cm7) void MCDRV_QdEncSetPosMe(mcdrv_qd_enc_t *this, frac16_t f16PosMe)
{
    frac16_t f16CntMod;
 ...
 * @return none
 */
__RAMFUNC(SRAM_ITC_cm7) void MCDRV_QdEncSetDirection(mcdrv_qd_enc_t *this)
{
