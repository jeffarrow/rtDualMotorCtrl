...
__RAMFUNC(SRAM_ITC_cm7) static FMSTR_U8 _FMSTR_TriggerRec(FMSTR_REC *recorder)
{
    /* must be configured */
    if (recorder->flags.flg.isConfigured == 0U)
    {
...
__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare8S(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetS8(varData->cfg.addr), FMSTR_GetS8(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare8U(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetU8(varData->cfg.addr), FMSTR_GetU8(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare16S(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetS16(varData->cfg.addr), FMSTR_GetS16(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare16U(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetU16(varData->cfg.addr), FMSTR_GetU16(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare32S(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetS32(varData->cfg.addr), FMSTR_GetS32(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare32U(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetU32(varData->cfg.addr), FMSTR_GetU32(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare64S(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetS64(varData->cfg.addr), FMSTR_GetS64(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_Compare64U(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetU64(varData->cfg.addr), FMSTR_GetU64(varData->cfg.trgAddr));
}

#if FMSTR_REC_FLOAT_TRIG > 0
__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_CompareFloat(FMSTR_REC_VAR_DATA *varData)
{
    return CMP(FMSTR_GetFloat(varData->cfg.addr), FMSTR_GetFloat(varData->cfg.trgAddr));
}

__RAMFUNC(SRAM_ITC_cm7) static FMSTR_BOOL _FMSTR_CompareDouble(FMSTR_REC_VAR_DATA *varData)
{
...
__RAMFUNC(SRAM_ITC_cm7) void FMSTR_Recorder(FMSTR_INDEX recIndex)
{
...
__RAMFUNC(SRAM_ITC_cm7) static void _FMSTR_Recorder2(FMSTR_REC *recorder)
{
