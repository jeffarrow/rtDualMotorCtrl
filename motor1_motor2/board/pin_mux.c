...
void BOARD_InitPWM(void) {
  ...
  IOMUXC_SetPinConfig(
      ...
      0x10B0U);
  XBARA_SetSignalsConnection(XBARA, kXBARA1_InputAcmp4Out, kXBARA1_OutputFlexpwm1Fault0); /* ACMP4_OUT output assigned to XBARA_IN29 input is connected to XBARA_OUT35 output assigned to FLEXPWM1_FAULT0 */
...
- pin_list:
  ...
  - {pin_num: '83', peripheral: CMP4, signal: 'IN, 3', pin_signal: GPIO_AD_B1_07}
