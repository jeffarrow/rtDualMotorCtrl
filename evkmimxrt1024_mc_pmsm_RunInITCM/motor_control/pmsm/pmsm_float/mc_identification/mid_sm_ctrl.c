...
mid_pfcn_void_pms g_MID_SM_STATE_TABLE[10] = {
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateStart(mid_sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StatePwrStgCharact(mid_sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateRs(mid_sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateLd(mid_sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateLq(mid_sm_app_ctrl_t *psAppCtrl)
{
    /* call user Ls function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StatePp(mid_sm_app_ctrl_t *psAppCtrl)
{
    /* call user Ls function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateKe(mid_sm_app_ctrl_t *psAppCtrl)
{
    /* call user Ls function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateMech(mid_sm_app_ctrl_t *psAppCtrl)
{
    /* call user Ls function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateHall(mid_sm_app_ctrl_t *psAppCtrl)
{
    /* call user Ls function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void MID_SM_StateStop(mid_sm_app_ctrl_t *psAppCtrl)
{
