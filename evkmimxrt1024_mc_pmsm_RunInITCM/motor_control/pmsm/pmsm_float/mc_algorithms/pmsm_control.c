 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void MCS_PMSMFocCtrl(mcs_pmsm_foc_t *psFocPMSM)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void MCS_PMSMFocCtrlSpeed(mcs_speed_t *psSpeed)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void MCS_PMSMFocCtrlPosition(mcs_position_t *psPosition)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void MCS_PMSMAlignment(mcs_alignment_t *psAlignment)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void MCS_PMSMOpenLoopStartUp(mcs_pmsm_startup_t *psStartUp)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void MCS_PMSMScalarCtrl(mcs_pmsm_scalar_ctrl_t *psScalarPMSM)
{
...
@return  N/A
******************************************************************************/
__RAMFUNC(SRAM_ITC_cm7) static void MCS_DTComp(GMCLIB_2COOR_ALBE_T_FLT *sUAlBeDTComp,
                       GMCLIB_3COOR_T_FLT *sIABC,
                       float_t fltUDcBusFilt,
                       float_t fltPwrStgCharIRange,
                       float_t fltPwrStgCharLinCoeff)
