...
sm_app_state_fcn_t s_M1_STATE_FAST = {M1_StateFaultFast, M1_StateInitFast, M1_StateStopFast, M1_StateRunFast};

/*! @brief Application state machine table - slow */
sm_app_state_fcn_t s_M1_STATE_SLOW = {M1_StateFaultSlow, M1_StateInitSlow, M1_StateStopSlow, M1_StateRunSlow};

/*! @brief Application sub-state function field - fast */
pfcn_void_void s_M1_STATE_RUN_TABLE_FAST[7] = {
...
pfcn_void_void s_M1_STATE_RUN_TABLE_SLOW[7] = {
...
sm_app_trans_fcn_t s_TRANS = {M1_TransFaultStop, M1_TransInitFault, M1_TransInitStop, M1_TransStopFault,
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateFaultFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateInitFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateStopFast(void)
{
    /* read ADC results (ADC triggered by HW trigger from PDB) */
    /* get all adc samples - DC-bus voltage, current, bemf and aux sample */
    M1_MCDRV_ADC_GET(&g_sM1AdcSensor);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunFast(void)
{
    /* get all adc samples - DC-bus voltage, current, bemf and aux sample */
    M1_MCDRV_ADC_GET(&g_sM1AdcSensor);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateFaultSlow(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateInitSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateStopSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunSlow(void)
{
    /* Run sub-state function */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransFaultStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransInitFault(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransInitStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransStopFault(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransStopRun(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunFault(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunStop(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunCalibFast(void)
{
...
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunMeasureFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunReadyFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunAlignFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunStartupFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunSpinFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunFreewheelFast(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunCalibSlow(void)
{
    if (--g_sM1Drive.ui16CounterState == 0U)
    {
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunMeasureSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunReadySlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunAlignSlow(void)
{
}
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunStartupSlow(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunSpinSlow(void)
{
    if (g_sM1Drive.eControl == kControlMode_SpeedFOC)
    {
        /* Actual speed filter */
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_StateRunFreewheelSlow(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunCalibReady(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunCalibMeasure(void)
{
...
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunMeasureReady(void)
{
    /* Type the code to do when going from the RUN CALIB to the RUN READY sub-state */
    /* Set off measurement */
    g_sMID.bEnableMeasurement = FALSE;
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunReadyAlign(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunAlignStartup(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunAlignSpin(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunAlignReady(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunStartupSpin(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunStartupFreewheel(void)
{
    M1_MCDRV_PWM3PH_DIS(&g_sM1Pwm3ph);
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunSpinFreewheel(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_TransRunFreewheelReady(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_ClearFOCVariables(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) static void M1_FaultDetection(void)
{
 ...
 * @return None
 */
__RAMFUNC(SRAM_ITC_cm7) void M1_SetAppSwitch(bool_t bValue)
{
