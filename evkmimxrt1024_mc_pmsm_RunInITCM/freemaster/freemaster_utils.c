...
/* Copy variable to destination by bytes from an aligned source address */
__RAMFUNC(SRAM_ITC_cm7) FMSTR_INLINE void _FMSTR_CopySrcAligned_U32(FMSTR_U8 *dest, FMSTR_U32 *src)
{
    union
    {
        FMSTR_U32 n;
...
/* Copy variable to destination by bytes from an aligned source address */
__RAMFUNC(SRAM_ITC_cm7) FMSTR_INLINE void _FMSTR_CopySrcAligned_U16(FMSTR_U8 *dest, FMSTR_U16 *src)
{
    union
    {
        FMSTR_U16 n;
...
__RAMFUNC(SRAM_ITC_cm7) static void _FMSTR_MemCpySrcAligned(FMSTR_ADDR dest, FMSTR_ADDR src, FMSTR_SIZE size)
{
...
__RAMFUNC(SRAM_ITC_cm7) FMSTR_WEAK void FMSTR_MemCpyFrom(FMSTR_ADDR destAddr, FMSTR_ADDR srcAddr, FMSTR_SIZE size)
{
